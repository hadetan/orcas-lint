...
- If multiple repos exist, use the **AskUserQuestion** tool:
  - Header: `Repository`
...
Use the **AskUserQuestion** tool when the user did not specify a target:
...
Use the **AskUserQuestion** tool when there are multiple fixable findings:
